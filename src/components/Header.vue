  ...
  <header class="flex justify-between fixed z-30 w-full bg-white">
      ...
      <div class="flex items-center xl:w-64 xl:bg-white pl-4">
        ...
        <a href="#">
          <svg width="200" height="55" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Надпись NewTube -->
            <text x="85" y="50" font-family="Arial, sans-serif" font-size="24" fill="#000000">NewTube</text>
          </svg>
    ...
    <div class="flex items-center justify-end lg:w-1/4 sm:space-x-3 p-2 sm:px-4">
      ...
      <button class="relative group p-2 focus:outline-none">
        ...
        <div
            class="hidden opacity-0 group-hover:opacity-100 absolute top-9 right-0 sm:left-0 bg-white w-60 border border-t-0">
      ...
      <button class="relative group p-2 focus:outline-none">
        ...
        <div
            class="hidden opacity-0 group-hover:opacity-100 absolute top-9 -right-full sm:right-0 bg-white w-72 border border-t-0">
          <section class="py-2 border-b">
            <ul>
              <li>
